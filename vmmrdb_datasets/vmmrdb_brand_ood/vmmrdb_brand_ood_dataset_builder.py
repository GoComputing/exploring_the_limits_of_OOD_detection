...
class Builder(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for vmmrdb_brand_ood dataset."""

  VERSION = tfds.core.Version('1.0.0')
  RELEASE_NOTES = {
      '1.0.0': 'Initial release.',
  }
  DATASET_DIR = '/mnt/homeGPU/aurrea_cpelaez/datasets/VMMRdb_splits/brand'
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(vmmrdb_brand_ood): Downloads the data and defines the splits
