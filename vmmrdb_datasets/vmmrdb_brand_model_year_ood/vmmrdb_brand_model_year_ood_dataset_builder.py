"""vmmrdb_brand_model_year_ood dataset."""
...
class Builder(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for vmmrdb_brand_model_year_ood dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(vmmrdb_brand_model_year_ood): Downloads the data and defines the splits
